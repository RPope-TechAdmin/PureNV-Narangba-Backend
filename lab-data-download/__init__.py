...
GROUP_TO_TABLE: Dict[str, str] = {
    "fixtotal": "Narangba.Fixation",     # Fixation Totals
    "fixtclp": "Narangba.FixationTCLP",    # Fixation TCLP Values
    "twint": "Narangba.TradeWaste",     # Internal Trade Waste Testing
...
ALLOWED_COLUMNS: Dict[str, Iterable[str]] = {
    "Narangba.Fixation": {
        "pH","Moisture Content","Arsenic","Cadmium","Chromium","Copper","Lead","Nickel","Zinc","Mercury","Initial pH","After HCl pH","Extraction Fluid Number","Final pH","TCLP Extraction Fluid Number","Naphthalene","Acenaphthalene"
        ,"Acenaphthene","Fluorene","Phenathrene","Anthracene","Fluoranthene","Pyrene","Benz-a-anthracene","Chrysene","Benzo-b+j-fluoranthene","Benzo-k-fluoranthene","Benzo-a-pyrene","Indeno-1,2,3,cd-pyrene","Dibenz-a,h-anthracene","Benzo-g,h,i-Perylene"
        ,"PAH's Sum","Benzo-a-pyrene TEQ 0","Benzo-a-pyrene TEQ Half LOR","Benzo-a-pyrene TEQ LOR","C6 - C9 Fraction","C10 - C14 Fraction","C15 - C28 Fraction","C29 - C36 Fraction","C10 - C36 Fraction (sum)","C6 - C10 Fraction","C6 - C10 Fraction  minus BTEX (F1)"
        ,">C10 - C16 Fraction",">C16 - C34 Fraction",">C34 - C40 Fraction",">C10 - C40 Fraction (sum)",">C10 - C16 Fraction minus Naphthalene (F2)","Benzene","Toluene","Ethylbenzene","meta- & para-Xylene","ortho-Xylene","Total Xylenes","Sum of BTEX","BTEXNaphthalene"
        ,"1.2-Dichloroethane-D4","Toluene-D8","4-Bromofluorobenzene"
    },
    "Narangba.FixationTCLP": {
        "Arsenic","Cadmium","Chromium","Copper","Lead","Nickel","Zinc","C10 - C14 Fraction","C15 - C28 Fraction","C29 - C36 Fraction","C10 - C36 Fraction (sum)",">C10 - C16 Fraction",">C16 - C34 Fraction",">C34 - C40 Fraction",">C10 - C40 Fraction (sum)",">C10 - C16 Fraction minus Naphthalene (F2)"
        ,"C6 - C9 Fraction","C6 - C10 Fraction","C6 - C10 Fraction  minus BTEX (F1)","Benzene","Toluene","Ethylbenzene","meta- & para-Xylene","ortho-Xylene","Total Xylenes","Sum of BTEX","Naphthalene","1.2-Dichloroethane-D4","Toluene-D8","4-Bromofluorobenzene"    
    },

    "Narangba.TradeWaste": {
        "pH Value","Dissolved Solids","Suspended Solids","Sulfate as SO4 - Turbidimetric","Arsenic","Cadmium","Chromium","Copper","Lead","Nickel","Zinc","Iron","Mercury","Nitrite + Nitrate as N","Total Kjeldahl Nitrogen as N","Total Nitrogen as N","Total Phosphorus as P","Total Organic Carbon"
        ,"Chemical Oxygen Demand","Biochemical Oxygen Demand","Oil & Grease","C6 - C9 Fraction","C10 - C14 Fraction","C15 - C28 Fraction","C29 - C36 Fraction","C10 - C36 Fraction (sum)","C6 - C10 Fraction","C6 - C10 Fraction  minus BTEX (F1)",">C10 - C16 Fraction",">C16 - C34 Fraction",">C34 - C40 Fraction"
        ,">C10 - C40 Fraction (sum)",">C10 - C16 Fraction minus Naphthalene (F2)","Benzene","Toluene","Ethylbenzene","meta- & para-Xylene","ortho-Xylene","Total Xylenes","Sum of BTEX","Naphthalene","1.2-Dichloroethane-D4","Toluene-D8","4-Bromofluorobenzene"   
    },
...
TABLE_ID_COLUMNS: Dict[str, List[str]] = {
    "Narangba.Fixation": ["Sample Date"],
    "Narangba.FixationTCLP":["Sample Date"],
    "Narangba.TradeWaste": ["Sample Date"],
    "Wacol.TradeWasteExt": ["Sample Date"]
}
